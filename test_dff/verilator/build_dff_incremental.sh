...
clang++ -flto -DVL_DEBUG -c -o verilated.o -I dff_obj -I/usr/local/share/verilator/include/vltstd -I/usr/local/share/verilator/include/ /usr/local/share/verilator/include/verilated.cpp
clang++ -flto -DVL_DEBUG -c -o verilated_vpi.o -I dff_obj -I/usr/local/share/verilator/include/vltstd -I/usr/local/share/verilator/include/ /usr/local/share/verilator/include/verilated_vpi.cpp
